            ...
            l = React.createClass({
                ...
                renderCanvas: function(e, t) {
                    ...
                    for (e.textBaseline = "alphabetic",
                        ...
                        if (s = t.industries[o],
                            s.dx > 40 && s.dy > 12) {
                            var y = t.getLongestText(s.name.toUpperCase() + (s.perf > 0 ? "+" : "") + s.perf.toFixed(2) + "%", d.industryFontSize, s.dx - 8);
            ...
            r = React.createClass({
                ...
                render: function() {
                    ...
                    var a = this.state.sparklinesData && this.state.sparklinesData[t.name],
                        ...
                        f = s.length > 15,
                        l = ("geo" !== o ? t.parent.parent.name + " - " : "") + t.parent.name + (t.parent.perf > 0 ? "+" : "") + t.parent.perf.toFixed(2) + "%";
                    return React.createElement("div", {
                        id: "hover"
                    }, React.createElement("h3", {
                        style: {
                            backgroundColor: r(t.parent.perf)
                        }
                    }, l), React.createElement("table", {
